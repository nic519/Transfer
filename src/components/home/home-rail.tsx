...
export function HomeRail({
  ...
  return (
    <aside className="relative z-50 self-start overflow-visible rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,12,21,0.94),rgba(8,12,21,0.82))] p-3 shadow-[0_24px_72px_rgba(0,0,0,0.28)] lg:sticky lg:top-6 lg:h-fit">
      ...
      {activePanel === "guide" ? (
        <div className="absolute left-[calc(100%+14px)] top-0 z-[60] w-[460px] rounded-[28px] border border-slate-900/10 bg-[linear-gradient(180deg,#f4f7fb_0%,#eef3f7_100%)] p-4 shadow-[0_24px_80px_rgba(15,23,42,0.18)]">
          <div>
          ...
          <div className="mt-4 space-y-4">
            <section className="rounded-[22px] border border-slate-900/10 bg-white/80 p-4">
              ...
              <pre className="mt-4 whitespace-pre-wrap break-words rounded-[18px] bg-slate-950 px-4 py-4 font-mono text-[12px] leading-6 text-slate-100">
                {`POST /api/proxy
...
${standardPayload}`}
            ...
            <section className="rounded-[22px] border border-slate-900/10 bg-white/80 p-4">
              ...
              <pre className="mt-4 whitespace-pre-wrap break-all rounded-[18px] bg-slate-950 px-4 py-4 font-mono text-[12px] leading-6 text-slate-100">
            ...
            <section className="rounded-[22px] border border-slate-900/10 bg-white/80 p-4">
              ...
              <pre className="mt-2 whitespace-pre-wrap break-words rounded-[18px] bg-slate-950 px-4 py-4 font-mono text-[12px] leading-6 text-slate-100">
                {`{
...
function RailButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex cursor-pointer items-center gap-2 rounded-[18px] border px-3 py-3 text-sm font-medium transition lg:flex-col lg:justify-center lg:px-2 lg:py-4 ${active
